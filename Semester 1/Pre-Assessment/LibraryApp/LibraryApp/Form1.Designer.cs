namespace LibraryApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBox3.Size = new System.Drawing.Size(663, 324);
			...
			// btnReturn
			// 
			this.btnReturn.Location = new System.Drawing.Point(140, 284);
			...
			this.gbAddBook.Controls.Add(this.rbtnMiscellaneous);
			this.gbAddBook.Controls.Add(this.rbtnDatabase);
			this.gbAddBook.Controls.Add(this.rbtnProgramming);
			this.gbAddBook.Controls.Add(this.label3);
			this.gbAddBook.Controls.Add(this.tbAuthor);
			this.gbAddBook.Controls.Add(this.label2);
			this.gbAddBook.Controls.Add(this.tbTitle);
			this.gbAddBook.Controls.Add(this.label1);
			this.gbAddBook.Location = new System.Drawing.Point(12, 62);
			this.gbAddBook.Name = "gbAddBook";
			this.gbAddBook.Size = new System.Drawing.Size(289, 230);
			this.gbAddBook.TabIndex = 3;
			...
			this.btnGetData.Size = new System.Drawing.Size(126, 43);
			this.btnGetData.TabIndex = 6;
			this.btnGetData.Text = "Openen";
